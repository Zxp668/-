...
diyicizhuanwanhoudezhixing_time=6.9
        ...
        for i in range(7):
            ...
            if i<3:
                if i == self.current_arm_index:#灌溉执行的标志位并没因避障过程浇水而+1
                    ...
                    while True:
                        print("卡task_A()在循环里了！！")
                        if self.min_dis[0] < A_huapen_thresh and self.min_dis[0] >= self.side_obstacle_thresh:
        ...
        for i in range(4):
            ...
            if i < 3:
                if i == self.current_arm_index:  # 灌溉执行的标志位并没因避障过程浇水而+1
                    ...
                    while True:
                        print("卡task_B()在循环里了！！")
                        if self.min_dis[1] < B_huapen_thresh and self.min_dis[1] >= self.side_obstacle_thresh:
                            print(COLOR_YELLOW + ">>>>>>>>>>>Stop." + STYLE_RESET)
                            self.dotime_stop()
                            break
                        else:
